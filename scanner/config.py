...
class ScannerConfig:
    ...
    MAX_PRICE:           float = field(default_factory=lambda: _f("MAX_PRICE", 5.0))
    MIN_VOLUME:          int   = field(default_factory=lambda: _i("MIN_VOLUME", 100_000))
    MIN_REL_VOLUME:      float = field(default_factory=lambda: _f("MIN_REL_VOLUME", 1.7))
    MIN_MARKET_CAP:      float = field(default_factory=lambda: _f("MIN_MARKET_CAP", 30_000_000))
    MIN_GAP_PCT:         float = field(default_factory=lambda: _f("MIN_GAP_PCT", 0.8))

    # Extended-hours thresholds
    MIN_VOLUME_EXTENDED:          int   = field(default_factory=lambda: _i("MIN_VOLUME_EXTENDED", 75_000))
    ...
    MAX_STAGE1_PASS:     int   = field(default_factory=lambda: _i("MAX_STAGE1_PASS", 160))
    MAX_STAGE2_PASS:     int   = field(default_factory=lambda: _i("MAX_STAGE2_PASS", 40))
    MAX_STAGE3_PASS:     int   = field(default_factory=lambda: _i("MAX_STAGE3_PASS", 20))
    TOP_PICKS:           int   = field(default_factory=lambda: _i("TOP_PICKS", 12))
    SCAN_INTERVAL_MIN:   int   = field(default_factory=lambda: _i("SCAN_INTERVAL_MINUTES", 7))
    YF_BATCH_SIZE_STAGE1: int  = field(default_factory=lambda: _i("YF_BATCH_SIZE_STAGE1", 5))
    ...
    YF_INFO_DELAY:        float = field(default_factory=lambda: _f("YF_INFO_DELAY", 0.18))

    # Extended-hours pipeline tuning
    MAX_STAGE1_PASS_EXTENDED:   int   = field(default_factory=lambda: _i("MAX_STAGE1_PASS_EXTENDED", 120))
    MAX_STAGE2_PASS_EXTENDED:   int   = field(default_factory=lambda: _i("MAX_STAGE2_PASS_EXTENDED", 30))
    MAX_STAGE3_PASS_EXTENDED:   int   = field(default_factory=lambda: _i("MAX_STAGE3_PASS_EXTENDED", 20))
    TOP_PICKS_EXTENDED:         int   = field(default_factory=lambda: _i("TOP_PICKS_EXTENDED", 10))
    SCAN_INTERVAL_MIN_EXTENDED: int   = field(default_factory=lambda: _i("SCAN_INTERVAL_MINUTES_EXTENDED", 7))
    YF_BATCH_SIZE_STAGE1_EXTENDED: int = field(default_factory=lambda: _i("YF_BATCH_SIZE_STAGE1_EXTENDED", 4))
    YF_INFO_DELAY_EXTENDED:        float = field(default_factory=lambda: _f("YF_INFO_DELAY_EXTENDED", 0.28))
